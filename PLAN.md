...
Each showcase runs with: `cd 01_ambient_scribe && uvicorn main:app --reload`
...
│   └── init-db.sql                    # pgvector extension + schema
│
├── data/
│   ├── audio/
...
- `01_ambient_scribe/app.py` — Streamlit app for Showcase 1
